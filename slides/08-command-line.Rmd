...
A hint for finding the paramters to a function is to select F1 when the cursor is in the word `render`. 
...
`r emo::ji("heavy_check_mark")` **RMarkdowns are self-contained** any data use needs to be coded in the script and not "pre-loaded" in RStudio
