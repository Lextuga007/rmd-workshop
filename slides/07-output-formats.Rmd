...
__hint: copying the text will help get the tabs right__
...
.footnote[(note: this requires you to install the [`bookdown` package](https://bookdown.org/yihui/bookdown/))]
