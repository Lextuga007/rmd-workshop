...
1. Install and add library() call for either [wesanderson](https://github.com/karthik/wesanderson) or [popthemes](https://github.com/johnmackintosh/popthemes)

1. Add a new parameter called `palette:` spaced like `series:`

1. Add and replace `choices` with colour from the package `choices: [choice1, choice2, choice3]`
