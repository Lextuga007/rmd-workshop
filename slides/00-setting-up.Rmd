...
Inline code ; Tabs ; Output Formats

--------- Break ---------

Command Line ; Parameters ; Loop reports
...
4. Name your project (default is `Untitled`)
...
???
When the rmds are opened RStudio will say along the top if there are any missing
packages from the code. 

But the next slide includes a package that isn't in the code {usethis}
