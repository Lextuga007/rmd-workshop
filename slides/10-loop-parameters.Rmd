...
This loop just overwrites the html file (check for the time run).
...
Extending the loop to named files
...
for (this_series in series) {
  rmarkdown::render(
    ...
    output_file = paste0("Report_", this_series))
}
...
???
output_format() defaults to html but just for clarity this is included
